 ...
 * @author syahrul
 */
public class pegawaiList extends javax.swing.JPanel {
    ...
    public void datatable() {
        ...
        try {
            ...
            List<Object[]> results = dmlSql.selectData("pegawai", columnsToSelect, joinTable, joinCondition, conditionColumns, operators, conditionValues, true,false);
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        pegawaiForm pegawaiCreate = new pegawaiForm(null);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        pegawaiForm pegawaiCreate = new pegawaiForm(id);
        pegawaiCreate.layout = layout;
