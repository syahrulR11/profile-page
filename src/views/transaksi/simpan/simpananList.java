 ...
 * @author syahrul
 */
public class simpananList extends javax.swing.JPanel {
    ...
    public void datatable() {
        Object[] Baris = {"ID","Nama","Email","No. Telp","Jenis Kelamin","Alamat","Pekerjaan","Tanggal Daftar"};
        tableModel = new DefaultTableModel(null,Baris);
        String search = cariInput.getText();
        try {
            String[] columnsToSelect = {"id","nama","email","no_telp","jenis_kelamin","alamat","pekerjaan","tgl_daftar"};
            String[] conditionColumns = {"nama","email"};
            String[] operators = {"LIKE","LIKE"};
            Object[] conditionValues = {"%"+search+"%","%"+search+"%"};
            List<Object[]> results = dmlSql.selectData("anggota", columnsToSelect, null, null, conditionColumns, operators, conditionValues, true,false);
    ...
    private void initComponents() {
        ...
        title.setText("Simpanan Anggota");
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        simpananAnggotaList simpananAnggotaList = new simpananAnggotaList(id);
        simpananAnggotaList.layout = layout;
        simpananAnggotaList.parent = this;
