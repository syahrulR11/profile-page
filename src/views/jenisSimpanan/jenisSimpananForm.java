 ...
 * @author syahrul
 */
public class jenisSimpananForm extends javax.swing.JPanel {
    private DatabaseManager dbManager;
    private DMLSQL dmlSql;
    private String id = null;
    public jenisSimpananList parent = null;
    public layout layout = null;

    /**
     * Creates new form pegawaiCreate
     */
    public jenisSimpananForm(String id) {
        initComponents();
    ...
    private void setData(String id) {
        String[] columnsToSelect = {"nama","bisa_ambil"};
        String[] conditionColumns = {"id"};
        String[] operators = {"="};
        Object[] conditionValues = {id};
        Object[] result;
        try {
            result = dmlSql.findData("jenis_simpanan", columnsToSelect, null, null, conditionColumns, operators, conditionValues, false,false);
            namaInput.setText((String)result[0]);
            bisaAmbilInput.setSelectedIndex("Ya".equals((String)result[1])?0:1);
    ...
    private void saveData() {
        try {
            if (this.id != null) {
                String[] insertColumns = {"nama","bisa_ambil"};
                Object[] insertValues = {namaInput.getText(), bisaAmbilInput.getSelectedItem().toString()};
                dmlSql.updateData("jenis_simpanan", insertColumns, insertValues, this.id);
                dbManager.close();
                JOptionPane.showMessageDialog(null, "Data Berhasil Diubah!");
                jenisSimpananList jenisSimpananList = new jenisSimpananList();
                jenisSimpananList.layout = layout;
                layout.pn_main.removeAll();
                layout.pn_main.add(jenisSimpananList);
                layout.pn_main.repaint();
                layout.pn_main.revalidate();
            } else {
                UUID uuid = UUID.randomUUID();
                String[] insertColumns = {"id","nama","bisa_ambil"};
                Object[] insertValues = {uuid.toString(), namaInput.getText(), bisaAmbilInput.getSelectedItem().toString()};
                dmlSql.insertData("jenis_simpanan", insertColumns, insertValues);
                dbManager.close();
    ...
    private void initComponents() {
        ...
        bisaAmbilInput = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Jenis Simpanan Form");
        ...
        jLabel3.setText("Bisa Ambil");

        bisaAmbilInput.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ya", "Tidak" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(bisaAmbilInput, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bisaAmbilInput, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void batalButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_batalButtonActionPerformed
        jenisSimpananList pegawaiList = new jenisSimpananList();
    ...
    private javax.swing.JComboBox<String> bisaAmbilInput;
