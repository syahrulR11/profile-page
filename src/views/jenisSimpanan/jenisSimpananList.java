 ...
 * @author syahrul
 */
public class jenisSimpananList extends javax.swing.JPanel {
    ...
    public void datatable() {
        Object[] Baris = {"ID","Nama","Bisa Ambil"};
        tableModel = new DefaultTableModel(null,Baris);
        String search = cariInput.getText();
        try {
            String[] columnsToSelect = {"id","nama","bisa_ambil"};
            String[] conditionColumns = {"nama","bisa_ambil"};
            String[] operators = {"LIKE","LIKE"};
            Object[] conditionValues = {"%"+search+"%","%"+search+"%"};
            List<Object[]> results = dmlSql.selectData("jenis_simpanan", columnsToSelect, null, null, conditionColumns, operators, conditionValues, true,false);
    ...
    private void initComponents() {
        ...
        title.setText("Jenis Simpanan Manajemen");
        ...
        tambahButton.setText("Tambah Jenis");
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        jenisSimpananForm pegawaiCreate = new jenisSimpananForm(null);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        jenisSimpananForm pegawaiCreate = new jenisSimpananForm(id);
        pegawaiCreate.layout = layout;
